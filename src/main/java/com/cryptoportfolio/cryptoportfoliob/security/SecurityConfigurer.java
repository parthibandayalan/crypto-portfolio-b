...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/portfolio/checkusername").permitAll()
		.antMatchers("/portfolio/create").permitAll()
...
//	}
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000","https://192.168.1.11:3000","http://pdcryptoportfolio.herokuapp.com"));      
